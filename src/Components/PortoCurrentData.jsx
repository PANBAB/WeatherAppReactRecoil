...
import {
  fetchPortoWeatherData,
  selectPortoWeatherData,
} from "../redux/PortoWeatherSlice";

const PortoCurrentData = () => {
  const dispatch = useDispatch();
  const PortoWeatherData = useSelector(selectPortoWeatherData);
  ...
  const { daily, hourly } = PortoWeatherData;
...
export default PortoCurrentData;
