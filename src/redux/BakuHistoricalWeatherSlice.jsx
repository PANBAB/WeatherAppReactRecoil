...
export const fetchBakuHistoricalData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://archive-api.open-meteo.com/v1/archive?latitude=40.4093&longitude=49.8671&start_date=2022-07-01&end_date=2023-11-28&models=best_match&daily=weathercode,temperature_2m_max,temperature_2m_min,precipitation_sum,rain_sum,snowfall_sum,precipitation_hours,winddirection_10m_dominant&timezone=Asia%2FBaku&min=2023-06-02&max=2023-11-28"
    );
