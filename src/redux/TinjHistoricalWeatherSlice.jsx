...
export const fetchTinjHistoricalData = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://archive-api.open-meteo.com/v1/archive?latitude=43.2248&longitude=16.9842&start_date=2022-07-01&end_date=2023-10-29&models=best_match&daily=weathercode,temperature_2m_max,temperature_2m_min,precipitation_sum,rain_sum,snowfall_sum,precipitation_hours,winddirection_10m_dominant&timezone=Europe%2FZagreb&min=2023-06-02&max=2023-10-29"
    );
